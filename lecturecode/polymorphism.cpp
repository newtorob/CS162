...
public: 
	...
	double perimeter()
	{
		...
		return this->side1 * 2 + this->side * 2;
	}
protected:
	double side1;
	double side2;
...
int main(argc, char **argv) 
{
	...
	std::cout << "Area of rectangle t: " << r.area() << std::endl; std::cout << "Perimeter of rectangle t: " << r.perimeter() << std::endl;

	std::cout << "Area of square q: " << q.area() << std::endl; std::cout << "Perimeter of square q: " << q.perimeter() << std::endl;
